...
export default function Hero() {
  ...
  {t('landing.welcome', 'Добро пожаловать в Renterya')}
</h1>

<p className="text-lg md:text-2xl opacity-90 dark:text-gray-100 max-w-3xl mx-auto leading-relaxed tracking-wide">
  {t('landing.subtitle', 'Прямая аренда — никаких посредников. Подписывайте и оплачивайте онлайн. Всё прозрачно, с лёгкой магией комфорта. ✨')}
</p>
