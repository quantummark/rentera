...
const TOPICS: TopicConfig[] = [
  {
    ...
    iconBgClass: 'bg-slate-200/40 dark:bg-slate-500/25',
    iconTintClass: 'text-slate-800 dark:text-slate-100',
  },
  {
    id: 'experience',
    icon: KeyRound,
    labelKey: 'community:topics.experience',
    iconBgClass: 'bg-orange-500/20 dark:bg-orange-400/25',
    iconTintClass: 'text-orange-700 dark:text-orange-200',
  },
  {
    id: 'roommates',
    icon: Users,
    labelKey: 'community:topics.roommates',
    iconBgClass: 'bg-emerald-500/20 dark:bg-emerald-400/25',
    iconTintClass: 'text-emerald-700 dark:text-emerald-200',
  },
  {
    id: 'household',
    icon: Wrench,
    labelKey: 'community:topics.household',
    iconBgClass: 'bg-sky-500/20 dark:bg-sky-400/25',
    iconTintClass: 'text-sky-700 dark:text-sky-200',
  },
  {
    id: 'moving',
    icon: Truck,
    labelKey: 'community:topics.moving',
    iconBgClass: 'bg-indigo-500/20 dark:bg-indigo-400/25',
    iconTintClass: 'text-indigo-700 dark:text-indigo-200',
  },
  {
    id: 'finance',
    icon: Wallet,
    labelKey: 'community:topics.finance',
    iconBgClass: 'bg-amber-500/20 dark:bg-amber-400/25',
    iconTintClass: 'text-amber-700 dark:text-amber-200',
  },
  {
    id: 'fun',
    icon: Smile,
    labelKey: 'community:topics.fun',
    iconBgClass: 'bg-pink-500/20 dark:bg-pink-400/25',
    iconTintClass: 'text-pink-700 dark:text-pink-200',
  },
  {
    id: 'recommendations',
    icon: MapPin,
    labelKey: 'community:topics.recommendations',
    iconBgClass: 'bg-teal-500/20 dark:bg-teal-400/25',
    iconTintClass: 'text-teal-700 dark:text-teal-200',
  },
];
...
export default function CommunityTopicMenu({
  ...
  return (
    <nav
      ...
      className={cn(
        'w-full rounded-2xl bg-background/60 dark:bg-slate-900/60',
        'border border-gray-300 dark:border-slate-800/80',
